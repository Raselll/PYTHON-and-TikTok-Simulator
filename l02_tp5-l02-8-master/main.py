...
def main() -> CompteTikTok:
    ...
    wako.__iadd__(chaussures)
    wako += chaussures

    # TODO : Ajouter (+=) les chaussures à Bob
    bob.__iadd__(chaussures)
    bob += chaussures

    # TODO : Ajouter (+=) le chapeau à Bob
    bob.__iadd__(chapeau)
    bob += chapeau
    ...
    meilleur_animal, score = calcul_meilleur_animal(animaux)[0]
    ...
    nombre_tiktok_compte = len(compte._CompteTiktok_tiktoks)
